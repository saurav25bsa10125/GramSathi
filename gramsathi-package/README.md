...
10. **3D Isometric Community Kiosk Wall Display**
...
│   ├── views.js                # UI renderers for all 13 modules & Kiosk wall display
...
2. **Energy Panel:**
   ...
   - Click **"Battery Critical"** → observe Battery drop to 18%, warning alert trigger, and Kiosk map update.
...
8. **Community Kiosk Wall Display:**
   - Click **"Kiosk Wall Display"** → experience the animated isometric village map with live energy and water flow.
